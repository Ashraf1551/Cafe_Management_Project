...
void intro()
{
    ...
    printf("\t\t|----------------------------------------|\n");
    printf("\t\t|       ~ Ali Ashraf Emon    (1551)      |\n");
    printf("\t\t|       ~ Zakia Sultana Zitu (1855)      |\n");
    printf("\t\t|       ~ Mehedi Islam Sami  (1582)      |\n");
    printf("\t\t|       ~ Jannatul Mawa      (1071)      |\n");
    printf("\t\t|       ~ Roshaed Al Fardin  (1353)      |\n");
    printf("\t\t|----------------------------------------|\n");
    printf("\t\t|     Created by Team " RED "Errorr404 " GREEN "         |\n");
    printf("\t\t|----------------------------------------|\n\n\n" RESET);
}
